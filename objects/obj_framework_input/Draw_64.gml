...
if not screen or game.app.render.mode_ratio then 
	exit
...
internal_new_buttons += 512 * draw_btn2(_vw/2, _vh/2 + _h * 3, make_color_rgb(91,106,120), "start")
internal_new_buttons += 8 * draw_btn(gui_get_x_align(_w * 0.5, fa_right), _mh - _h * 1, make_color_rgb(222,185,50))
internal_new_buttons += 2 * draw_btn(gui_get_x_align(_w * 1.5, fa_right), _mh - _h * 0, make_color_rgb(189,91,76))
internal_new_buttons += 4 * draw_btn(gui_get_x_align(_w * 2.5, fa_right), _mh + _h * 1, make_color_rgb(119,130,188))
internal_new_buttons += 1 * draw_analog(padding + (_w * 1.25), _mh + _h * 1)
